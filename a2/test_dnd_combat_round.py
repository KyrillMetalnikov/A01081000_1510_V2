...
"""
    ...
    @patch('dnd.roll_hitpoints', side_effect=[2, 2])
    @patch('sys.stdout', new_callable=io.StringIO)
    def test_combat_round_player_two_first_with_retaliation(self, mock_sysout, _, __, ___):
        character = {"Name": "Xyxy",
                     "Strength": 10,
                     "Dexterity": 8,
                     "Intelligence": 5,
        ...
        expected = """Xyxy took the hit like a real champ but still took 2 damage!

Sad Jim took the hit like a real champ but still took 2 damage!
